...
public class Optimizer {
    ...
    // repeats are allowed
    public final static String[] optimizationNames = new String[] { "cse", "cp", "dce", "il", "ra", "as" };
    public final static Optimization[] optimizations = new Optimization[] { new CSE(), new CP(), new DCE(), new Inline(), new RegisterAllocation(), new CodeSimplifier() };
